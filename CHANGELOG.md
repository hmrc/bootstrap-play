...
- MDC Changes.
  ...
  This should mean that calls to `Mdc.preservingMdc` through out the code is largely unnecessary.
...
- The MDC tracking added in [Version 9.17.0](#version-9170) has been removed. It's largely invalidated by the changes aboe.
